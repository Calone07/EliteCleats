        ...
        <div className="relative z-10 mx-auto flex min-h-screen flex-col lg:flex-row">
          ...
          >
            ...
            <div className="relative z-10 h-64 w-64 sm:h-80 sm:w-80 lg:h-[28rem] lg:w-[28rem]">
              ...
              >
                <div className="relative h-full w-full rounded-2xl bg-gradient-to-br from-accent/[0.08] via-card-bg to-primary-bg border border-border shadow-2xl shadow-accent/5">
                  <Image
                    src="/images/boots/nike/kevinfooty_-hero.webp"
