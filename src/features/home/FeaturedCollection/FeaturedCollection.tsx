...
import { useCollectionAnimation } from "@/motion";

const collectionImage = "/images/collections/nike-mercurial.webp";

export function FeaturedCollection() {
  const sectionRef = useCollectionAnimation();
    ...
    <section ref={sectionRef} className="py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div
            data-fc-image
            className="relative aspect-[4/3] overflow-hidden rounded-xl border border-border bg-card-bg"
          >
            <Image
              src={collectionImage}
