  ...
  return (
    <section className="py-20 sm:py-28">
      <Container>
        <div
          ref={revealRef}
          className="relative overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-accent/5 via-transparent to-accent/5 px-6 py-16 text-center sm:px-12 sm:py-20 lg:px-20"
        >
